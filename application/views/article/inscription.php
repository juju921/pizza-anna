...
<div id="body">
    ...
    <div class="control-group">
     ...
     <label class="checkbox inline" for="m">
      <input type="checkbox" id="m" value="option1" name="civilite" >M.
    </label>
    <label class="checkbox inline" for="mme">
      <input type="checkbox" id="mme" value="option2" name="civilite" > Mme
    </label>
    <label class="checkbox inline" for="mlle">
      <input type="checkbox" id="mlle" value="option3" name="civilite">Mlle
    </label>
  </div>
  ...
  <div class="control-group">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" name="heure" placeholder="heure de passage" value="<?php echo set_value('heure');?>">
      </div>
    </div>
